                ...
                <tbody>
                    <tr className='border-b hover:bg-gray-50 transition duration-200'>
                        <td className='py-3 px-4 flex items-center gap-4'>
                            <img src={img} className='w-25 h-15 object-cover rounded-md' alt="" />
                            <span>Title</span>
                        </td>
                        <td className='px-4 py-3'>₹ NA</td>

                        <td className='px-4 py-3'><span className='px-3 py-1 rounded-full text-xs bg-red-600'>Draft</span></td>
        ...
        <div className='md:hidden space-y-4'>
            <div className='bg-white rounded-lg shadow p-4 flex flex-col gap-3'>
                <div className='flex gap-4 items-center'>
                    <img src={img} className='h-16 w-16 rounded-md object-cover' alt="" />
